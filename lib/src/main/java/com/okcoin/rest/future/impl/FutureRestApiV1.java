...
import com.okcoin.rest.OkhttpHttpUtilManager;
...
public class FutureRestApiV1 implements IFutureRestApi {
	 ...
	 * kline
	 */
	private final String BATCH_KLINE_URL = "/api/v1/future_kline.do";
	...
	public String future_ticker(String symbol, String contractType)
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex,FUTURE_TICKER_URL, param);
	...
	public String future_index(String symbol) throws HttpException, IOException {
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex,FUTURE_INDEX_URL, param);
		// System.out.println(result);
		return result;
	}
	...
	public String future_trades(String symbol, String contractType)
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex,FUTURE_TRADES_URL, param);
		// System.out.println(result);
		return result;
	}
	...
	public String future_depth(String symbol, String contractType)
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex,FUTURE_DEPTH_URL, param);
		// System.out.println(result);
		return result;
	}
	...
	public String exchange_rate() throws HttpException, IOException {
		String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex,FUTURE_EXCHANGE_RATE_URL, null);
		// System.out.println(result);
		return result;
	}
	...
	public String future_cancel(String symbol, String contractType,
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex,FUTURE_CANCEL_URL, params);
		// System.out.println(result);
		return result;
	...
	public String future_trade(String symbol, String contractType,
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex,this.FUTURE_TRADE_URL, params);
		// System.out.println(result);
		return result;
	}
	...
	public String future_userinfo() throws HttpException, IOException {
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex,this.FUTURE_USERINFO_URL,
				params);
		// System.out.println(result);
		return result;
	}
	...
	public String future_userinfo_4fix()
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex,this.FUTURE_USERINFO_4FIX_URL,
				params);
		// System.out.println(result);
		return result;
	}
	...
	public String future_position(String symbol, String contractType)
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex,this.FUTURE_POSITION_URL,
				params);
		// System.out.println(result);
		return result;
	...
	public String future_position_4fix(String symbol, String contractType)
		...
		params.put("sign", sign);
		// 发送post请求
		String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex,this.FUTURE_POSITION_4FIX_URL,
				params);
		// System.out.println(result);
		return result;
	}
	...
	public String future_order_info(String symbol, String contractType,
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex,this.FUTURE_ORDER_INFO_URL,
				params);
		// System.out.println(result);
		return result;
	...
	@Override
	public String kline(String symbol, String type, String contract_type, String size, String since) throws HttpException, IOException {
		// 发送post请求
		String param = "";
		if (!StringUtil.isEmpty(symbol)) {
			if (!param.equals("")) {
		...
		String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex, this.BATCH_KLINE_URL, param);
