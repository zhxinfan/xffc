...
public class StockRestApi implements IStockRestApi {
     ...
     * kline
     */
    private final String BATCH_KLINE_URL = "/api/v1/kline.do";
    ...
    public String ticker(String symbol) throws HttpException, IOException {
        ...
        String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex, TICKER_URL, param);
        return result;
    }
    ...
    public String depth(String symbol) throws HttpException, IOException {
        ...
        String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex, this.DEPTH_URL, param);
        return result;
    }
    ...
    public String trades(String symbol, String since) throws HttpException, IOException {
        ...
        String result = OkhttpHttpUtilManager.getInstance().requestHttpGet(url_prex, this.TRADES_URL, param);
        return result;
    }
    ...
    public String userinfo() throws HttpException, IOException {
        ...
        // 发送post请求
        String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex, this.USERINFO_URL,
                params);
    ...
    public String trade(String symbol, String type,
        ...
        // 发送post请求
        String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex, this.TRADE_URL,
                params);
    ...
    public String batch_trade(String symbol, String type,
        ...
        // 发送post请求
        String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex, this.BATCH_TRADE_URL,
                params);
    ...
    public String cancel_order(String symbol, String order_id) throws HttpException, IOException {
        ...
        // 发送post请求
        String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex, this.CANCEL_ORDER_URL,
                params);
    ...
    public String order_info(String symbol, String order_id) throws HttpException, IOException {
        ...
        // 发送post请求
        String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex, this.ORDER_INFO_URL,
                params);
    ...
    public String orders_info(String type, String symbol,
        ...
        // 发送post请求
        String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex, this.ORDERS_INFO_URL,
                params);
    ...
    public String order_history(String symbol, String status,
        ...
        // 发送post请求
        String result = OkhttpHttpUtilManager.getInstance().requestHttpPost(url_prex, this.ORDER_HISTORY_URL,
                params);
